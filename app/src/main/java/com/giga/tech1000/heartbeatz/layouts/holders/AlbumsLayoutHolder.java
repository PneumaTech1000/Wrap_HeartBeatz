...
import com.giga.tech1000.heartbeatz.ui.adapters.AlbumViewAdapter;
...
public class AlbumsLayoutHolder extends LibraryLayoutHolder {
    ...
    public AlbumsLayoutHolder(@NonNull View itemView, MediaNavigation navigation) {
        super(itemView);
    ...
    protected void onBindContent(BaseLayoutItem item) {
        ...
        if (adapter == null) {
            adapter = new AlbumViewAdapter(layoutItem.getItems(), mediaNavigation);
