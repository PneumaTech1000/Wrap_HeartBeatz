...
public class MediaDetailsWithoutImgViewItem extends BaseRecyclerViewItem {


    private final Song song;

    public MediaDetailsWithoutImgViewItem(Song song) {
    ...
    public String toString() {
        return "MediaDetailsWithoutImgViewItem{" +
                "song=" + song +
                '}';
    }
}
